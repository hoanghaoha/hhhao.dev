    ...
    <div className="flex flex-col px-100 py-10 gap-10">
      ...
      <div className="space-y-4 leading-relaxed text-muted-foreground">
        ...
        <p>
          ...
          <a href={PROJECTS[0].github} target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-foreground hover:bg-primary transition-colors">survy</a>,{" "}
          an open source Python library for automated data processing,{" "}
          <a href={PROJECTS[1].github} target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-foreground hover:bg-primary transition-colors">survy-agent-skills</a>{" "}
          for AI-powered workflows, and{" "}
          <a href={PROJECTS[2].github} target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-foreground hover:bg-primary transition-colors">surveydb</a>{" "}
